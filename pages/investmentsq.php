...
?>
    ...
    <title>
	     <?php 
	         $investments = R::load('investments', (int)$_GET['id']);
		     echo $investments['title'];  
		 ?>
	</title>
	<!-- description -->
	<meta name="description" <?php echo'content="'.$investments['description'].'"'; ?> 
	<!-- Bootstrap CSS -->
			     ...
			     <div class="col-sm-10">
				     <?php 
					     if(true) // true 
						    ...
						    // в <title> / $investments = R::load('investments', (int)$_GET['id']);
							 echo '<br/>';
							 echo '<h1><small><strong>'; echo $investments['title']; echo '</strong></small></h1>'; 
							 echo '<h2><small><small><small>'; 
							 echo $investments['pubdate']; echo '<br/><br/>'; echo "
