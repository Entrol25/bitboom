...
?>
	...
	<!-- description -->
	<meta name="description" content="Список статей о криптоинвестициях.">
	<!-- Bootstrap CSS -->
		     ...
		     <div class="row text-left">
				 ...
				 <div align="center" class="nav-link">
				     <div>
					     <a href="https://www.bestchange.ru/?p=943002" rel="nofollow" target="_blank">
						     <img src="https://www.bestchange.ru/images/banners/240x400-9.gif" class="img-fluid"
						     alt="Лучшие курсы обмена валют WM" title="BestChange.ru - Мониторинг обменников в интернете. Подробнее в разделе Новичкам,  статья - Как купить криптовалюту." width="220" border="0" />
						 </a>
					 </div>
				 </div>
				 ...
				 <div id="spisoccenter" align="left">
					     ...
					     <?php 
								 ...
								 {
									 $i++;
									 echo '<a href="investmentsq.php?id='.$i.'" id="title">';
									 
									 $titleid = $i;
									 $investments = R::load('investments', $titleid);
									 echo '<strong>'; echo $investments['title']; echo '</strong>';
									 if($i == 1)
									 {
										 echo' _<big id="mycrypto"><b> Crypto </b></big>';
									 }
									 if($i > 1)
									 {
										 echo' _<big id="x50"><b> 50X </b></big>';
									 }
									 echo '<br/><br/>';
									 if($i >= 8)
									 { break;}
