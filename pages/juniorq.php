...
?>
    ...
    <title>
	     <?php 
	         $junior = R::load('junior', (int)$_GET['id']);
		     echo $junior['title'];  
		 ?>
	</title>
	<!-- description -->
	<meta name="description" <?php echo'content="'.$junior['description'].'"'; ?> 
	<!-- Bootstrap CSS -->
		     ...
		     <div class="row text-left">
			     ...
			     <div class="col-sm-10">
					     ...
					     <?php 
						    ...
						    // в <title> / $junior = R::load('junior', (int)$_GET['id']);
							 echo '<br/>';
							 echo '<h1><small><strong>'; echo $junior['title']; echo '</strong></small></h1>'; 
							 echo '<h2><small><small><small>'; 
							 echo $junior['pubdate']; echo '<br/><br/>'; echo "
