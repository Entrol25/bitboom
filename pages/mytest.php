		                 ...
		                 <div class="collapse navbar-collapse" id="navbarSupportedContent">
		                     <ul class="navbar-nav mr-auto">
								 ...
								 <li class="nav-item active">
				                     <a href="mytest.php" class="nav-link">Тестовая страница</a>
				                 </li>
								 <li class="nav-item">
		     ...
		     <div class="row text-left">
			   <div class="col-sm-3">
				 ...
				 <div align="center" class="nav-link">
				     <a href="https://shop.trezor.io/?offer_id=10&aff_id=2829&file_id=155" target="_blank" alt="trezor" 
                     title='Холодный аппаратный кошелёк Trezor. Подробнее в статье - Что такое криптокошелёк.'>
                         <img class="img-fluid" src="https://media.go2speed.org/brand/files/trezor/10/20181024084903-336x280.jpg" width="336" height="280" border="0" />
                     </a>
				     <div>
				 ...
				 <div align="center" class="nav-link">
				     <div>
				         <a href="https://promopult.ru/ref/cec0ac7949da2956" target="_blank">
                             <img src="../img/reklamma/boites.gif" border="0" 
				 ...
				 <div id="spisoccenter" align="left">
					     ...
					     <?php 
							     ...
							     while(true)
								 {
									 echo '//--------------------------------------------------------------//';
									 echo '<br/><br/>';
									 echo 'AMarkets Промокод: SBQ7S'; echo '<br/><br/>';
									 
									 echo 'Выгодные условия <br/>'; 
									 echo ' <a href="https://afinance.pro/fx-broker/g/SBQ7S" target="_blank" alt="mytest" title="mytest">
									             https://afinance.pro/fx-broker/g/SBQ7S
									        </a>'; echo '<br/><br/>';
									 
									 echo 'Профессиональный трейдинг <br/>'; 
									 echo ' <a href="https://afinance.pro/fx/g/SBQ7S" target="_blank" alt="mytest" title="mytest">
									             https://afinance.pro/fx/g/SBQ7S
									        </a>'; echo '<br/><br/>';
											
									 echo 'Заправь депозит <br/>'; 
									 echo ' <a href="https://afinance.pro/gasoline/g/SBQ7S" target="_blank" alt="mytest" title="mytest">
									             https://afinance.pro/gasoline/g/SBQ7S
									        </a>'; echo '<br/><br/>';
									 
									 echo 'Переход в AMarkets <br/>'; 
									 echo ' <a href="https://afinance.pro/transfer/g/SBQ7S" target="_blank" alt="mytest" title="mytest">
									             https://afinance.pro/transfer/g/SBQ7S
									        </a>'; echo '<br/><br/>';
											
									 echo 'Лучшие условия торговли <br/>'; 
									 echo ' <a href="https://afinance.pro/g/SBQ7S" target="_blank" alt="mytest" title="mytest">
									             https://afinance.pro/g/SBQ7S
									        </a>'; echo '<br/><br/>';
									 
									 echo 'Научитесь зарабатывать с AMarkets <br/>'; 
									 echo ' <a href="https://afinance.pro/neweducation/g/SBQ7S" target="_blank" alt="mytest" title="mytest">
									             https://afinance.pro/neweducation/g/SBQ7S
									        </a>'; echo '<br/><br/>';
											
									 echo 'Форма регистрации <br/>'; 
									 echo ' <a href="https://my.amarkets.biz/sign_up/real_full/new/g/SBQ7S" target="_blank" alt="mytest" title="mytest">
									             https://my.amarkets.biz/sign_up/real_full/new/g/SBQ7S
									        </a>'; echo '<br/><br/>';
									 ...
									 $i++;
									 /*
									 echo '<a href="trainingq.php?id='.$i.'" id="title">';
									 
									 $titleid = $i;
									 $training = R::load('training', $titleid);
									 echo '<strong>'; echo $training['title']; echo '</strong>';
									 if($i == 8)
									 {
										 echo' _<big id="trezor"><b> Trezor </b></big>';
									 }
									 if($i == 10)
									 {
										 echo' _<big id="trezor"><b> Epayments </b></big>';
									 }
									 echo '<br/><br/>';
									 */
									 if($i >= 1)
					 ...
					 <div align="center" class="nav-link">
					     <div>
					         <a href="https://www.gvgmall.com/?aid=742025" target="_blank">
                                 <img src="../img/junior/gvgmall2.png" 
