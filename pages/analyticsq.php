...
?>
    ...
    <title>
	     <?php 
	         $analytics = R::load('analytics', (int)$_GET['id']);
		     echo $analytics['title'];  
		 ?>
	</title>
	<!-- description -->
	<meta name="description" <?php echo'content="'.$analytics['description'].'"'; ?> 
	<!-- Bootstrap CSS -->
		     ...
		     <div class="row text-left">
			     ...
			     <div class="col-sm-10">
					     <?php 
						     ...
						     // в <title> / $analytics = R::load('analytics', (int)$_GET['id']);
							 echo '<br/>';
							 echo '<h1><small><strong>'; echo $analytics['title']; echo '</strong></small></h1>'; 
							 echo '<h2><small><small><small>'; 
							 echo $analytics['pubdate']; echo '<br/><br/>'; echo "
