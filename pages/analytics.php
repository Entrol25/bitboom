...
?>
    ...
    <title>ХомаЛитика</title>
	<!-- description -->
	<meta name="description" content="Домашняя аналитика от нашего сайта для вас.">
	<!-- Bootstrap CSS -->
			   ...
			   <div class="col-sm-3">
				 ...
				 <div id="spisoccenter" align="left">
					     ...
					     <?php 
								 ...
								 {
									 $i++;
									 echo '<a href="analyticsq.php?id='.$i.'" id="title">';
									 
									 $titleid = $i;
									 $analytics = R::load('analytics', $titleid);
									 echo '<strong>'; echo $analytics['title']; echo '</strong>';
									 if($i == 8)
									 {
					 ...
					 <div align="center" class="nav-link">
					     <div>
					         <a href="https://www.gvgmall.com/?aid=742025" rel="nofollow" target="_blank">
                                 <img src="../img/junior/gvgmall2.png" width="220"
