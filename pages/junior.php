...
?>
	...
	<!-- description -->
	<meta name="description" content="Список статей для новичков, из которых вы узнаете, что такое биткоин, криптовалюта и блокчейн.">
	<!-- Bootstrap CSS -->
		     ...
		     <div class="row text-left">
				 ...
				 <?php 
					 if(true) // true
					 {
						 ...
						 {
							 echo '
							 <div align="center" class="nav-link"><div>
							 <a href="https://go.50x.com/ref/34000" rel="nofollow" target="_blank">
							 <img src="../img/reklamma/mybaner50x4.png" border="0" width="220"
							 class="img-fluid"  alt="партнёрская программа 50Х" title="Партнёрская программа 50Х. Подробнее в разделе Инвестиции, статья - Партнёрская программа 50Х."></a></div>
							 </div>
							 ';
						 }
						 if($myrandom0 == 2)
						 {
							 ...
							 <img src="../img/reklamma/boites.gif" border="0" width="220"
							 class="img-fluid"  alt="promopult" title="Promopult"></a></div>
							 </div>
							 ';
						 }
						 if($myrandom0 == 3)
				 ...
				 <div id="spisoccenter" align="left">
					     ...
					     <?php 
								 ...
								 {
									 $i++;
									 echo '<a href="juniorq.php?id='.$i.'" id="title">';
									 
									 $titleid = $i;
									 $junior = R::load('junior', $titleid);
									 echo '<strong>'; echo $junior['title']; echo '</strong>';
									 if($i == 8)
									 {
									 ...
									 if($i > 12)
									 {
										 echo' _<big id="trezor"><b> Учебка </b></big>';
									 }
									 echo '<br/><br/>';
									 if($i >= 12)
									 { break;}
				     ...
				     <div align="center" class="nav-link">
					     <div>
				             <a href="https://www.bestchange.ru/?p=943002" rel="nofollow" target="_blank">
						         <img src="https://www.bestchange.ru/images/banners/240x400-8.gif" class="img-fluid"
				 ...
				 <?php 
					 if(true) // true
					 {
						 ...
						 if($myrandom0 == 1)
						 {
							 ...
							 <img src="../img/reklamma/mybaner50x5.png" border="0" width="220"
							 class="img-fluid"  alt="50X100 Shop" title="50X100 Shop. Подробнее в разделе Инвестиции, статья - 50X100 Shop."></a></div>
							 </div>
							 ';
						 }
						 if($myrandom0 == 2)
						 ...
						 if($myrandom0 == 4)
						 {
							 ...
							 <img src="../img/junior/gvgmall2.png" border="0" width="220"
                                 class="img-fluid" alt="компьютерные игры" title="Компьютерные игры"></a></div>
							 </div>
							 ';
						 }
						 echo '
