			   ...
			   <div class="col-sm-3">
				 ...
				 <div align="center" class="nav-link">
				     <div>
				         <a href="https://promopult.ru/ref/cec0ac7949da2956" target="_blank">
                             <img src="../img/reklamma/kartaor.gif" 
				 ...
				 <div id="spisoccenter" align="left">
					     ...
					     <?php 
								 ...
								 {
									 $i++;
									 echo '<a href="differentq.php?id='.$i.'" id="title">';
									 
									 $titleid = $i;
									 $different = R::load('different', $titleid);
									 echo '<strong>'; echo $different['title']; echo '</strong>';
									 if($i == 8)
									 {
