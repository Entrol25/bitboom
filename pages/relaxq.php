...
<!-- /Yandex.Metrika counter -->  
    ...
    <title>
	     <?php 
	         ...
	         $relax = R::load('relax', (int)$_GET['id']);
		     echo $relax['title'];  
		 ?>
	</title>
	<!-- description -->
	<meta name="description" <?php echo'content="'.$relax['description'].'"'; ?> 
	<!-- Bootstrap CSS -->
		     ...
		     <div class="row text-left">
			     ...
			     <div class="col-sm-10">
					     <?php 
						     ...
						     // в <title> / $relax = R::load('relax', (int)$_GET['id']);
							 echo '<br/>';
							 echo '<h1><small><strong>'; echo $relax['title']; echo '</strong></small></h1>'; 
							 echo '<h2><small><small><small>'; 
							 echo $relax['pubdate']; echo '<br/><br/>'; echo "
