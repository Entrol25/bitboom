...
<!-- /Yandex.Metrika counter --> 
    ...
    <title>Крипто-Отдых</title>
	<!-- description -->
	<meta name="description" content="Разные полезности от нашего сайта для вас.">
	<!-- Bootstrap CSS -->
			   ...
			   <div class="col-sm-3">
				 ...
				 <div id="spisoccenter" align="left">
					     ...
					     <?php 
								 ...
								 {
									 $i++;
									 echo '<a href="relaxq.php?id='.$i.'" id="title">';
									 
									 $titleid = $i;
									 $relax = R::load('relax', $titleid);
									 echo '<strong>'; echo $relax['title']; echo '</strong>';
									 if($i == 8)
									 {
	     ...
	     <div class="container">
		     <div class="row text-left">
			     <div class="col-sm-12">
	                 <div align="center" class="nav-link">
					     <div>
				             <a href="https://go.50x.com/34000" target="_blank">
