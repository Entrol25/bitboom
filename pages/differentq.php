...
<!-- /Yandex.Metrika counter -->  
    ...
    <title>
	     <?php 
	         ...
	         $different = R::load('different', (int)$_GET['id']);
		     echo $different['title'];  
		 ?>
	</title>
	<!-- description -->
	<meta name="description" <?php echo'content="'.$different['description'].'"'; ?> 
	<!-- Bootstrap CSS -->
		     ...
		     <div class="row text-left">
			     ...
			     <div class="col-sm-10">
					     <?php 
						     ...
						     // в <title> / $different = R::load('different', (int)$_GET['id']);
							 echo '<br/>';
							 echo '<h1><small><strong>'; echo $different['title']; echo '</strong></small></h1>'; 
							 echo '<h2><small><small><small>'; 
							 echo $different['pubdate']; echo '<br/><br/>'; echo "
